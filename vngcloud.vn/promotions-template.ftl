    ...
    <div class="cloud-container v-section-inner article-detail mb-5">
        <div class="row position-relative">
            <div class="col-lg-8 col-md-7">
                ...
                <div class="article-detail__content pb-3">
                    <div class="article-detail-title mt-2 mb-3">
                        <b>${title.getData()}</b>
                    </div>
                    ...
                    <div class="article-footer pt-3 mt-3" style="border-top: 1px solid #eee">
                        ...
                        <ul class="list-unstyled pl-3">
                            <li><b>Hotline</b>: <a href="tel:19001549" target="_blank" title="1900 1549">1900 1549</a></li>
                            <li><b>Email</b>: <a href="mailto:support@vngcloud.vn" target="_blank" title="support@vngcloud.vn">support@vngcloud.vn</a></li>
                            <li><b>Website</b>: <a href="/" title="VNG Cloud – Trusted Partner for Digital Transformation">https://vngcloud.vn</a></li>
                            <li><b>Facebook</b>: <a href="https://facebook.com/vngcloud.vn" target="_blank" title="VNG Cloud Facebook Page">https://facebook.com/vngcloud.vn</a></li>
                        </ul>
                        <p style="background-color: #eaeaea;" class="text-center p-2"><b>VNG Cloud – Trusted Partner for Digital Transformation</b></p>
                    </div>
                ...
                <#if Tag?has_content>
                    <div class="tag-list mt-4">
                        <div class="article-section position-relative mr-2 pr-2 pl-3"><b>TAG</b></div>
                        ${Tag.getData()}
                    </div>
                </#if>
            ...
            <div class="col-lg-4 col-md-5">
                <div class="block-next pl-md-5">
                    <h5 class="section-title mb-3"><b><#if locale=='vi_VN'>Đọc tiếp<#else>Read more</#if></b></h5>
                    <div class="section-content">
                        ...
                        <#list groupArticle as next><#if countNext gt 2><#break> </#if>
                            ...
                            <#if exceptURL?seq_index_of(next.getArticleId()) lt 0 && allowedNext>
                                <#if !next?has_next || groupArticle[next?index + 1].getArticleId() != next.getArticleId()>
                                    ...
                                    <#assign xTitleNext=xPathTitle.selectSingleNode(rootElementNext).getStringValue()>
                                    ...
                                    <#assign xImage=xPathImage.selectSingleNode(rootElementNext).getStringValue()!''>
                                    <#assign imgJson=jsonFactoryUtil.createJSONObject(xImage)>
                                    ...
                                    <article class="article-next mb-3 w-100">
                                        <p class="article-thumbnail mb-0 mr-2">
                                            <a class="d-block w-100 h-100" href="${xURlNext}">
                                                <img alt="" class="lazyload img-cover" data-src="${urlImageNext}" />
                                            </a>
                                        </p>
                                        <p class="article-title mb-0" title="${xTitleNext}"> <a href="${xURlNext}"><b>${xTitleNext}</b></a>
                                        </p>
                                    </article>
                                </#if>
                            </#if>
        ...
        <div class="row">
            <div class="col-lg-8 col-md-7">
                ...
                <#assign currentArticleRelatedLinks=assetLinkLocalService.getDirectLinks(currentArticleAssetEntryEntryId)>
                <#if currentArticleRelatedLinks?size gt 0>
                    <div class="mt-4 pt-4" style="border-top: 1px solid #eee">
                        <div class="related-blog">
                            <h5 class="section-title mb-3 position-relative"> <b> <#if locale=='vi_VN'>Bài liên quan<#else> Related Articles</#if> </b> </h5>
                            <div class="rel-content">
                                <#list currentArticleRelatedLinks as link>
                                    ...
                                    <#if allowedRel>
                                        <#assign linkedAssetEntry=assetEntryLocalService.getEntry(linkedAssetEntryId)>
                                        <#assign linkedAssetEntryPrimaryKey=linkedAssetEntry.getClassPK()>
                                        ...
                                        <#assign xPathTitle=saxReaderUtil.createXPath("dynamic-element[@name='title']/dynamic-content[@language-id='${locale}']")>
                                        <#assign xTitleRelated=xPathTitle.selectSingleNode(rootElement).getStringValue()>
                                        <#assign xPathDescRelated=saxReaderUtil.createXPath("dynamic-element[@name='Description']/dynamic-content[@language-id='${locale}']")>
                                        ...
                                        <#assign xPathImage=saxReaderUtil.createXPath("dynamic-element[@name='thumbnailImage']/dynamic-content[@language-id='${locale}']")>
                                        <#assign xImage=xPathImage.selectSingleNode(rootElement).getStringValue()!''>
                                        <#assign imgJson=jsonFactoryUtil.createJSONObject(xImage)>
                                        <#if xImage?has_content && xImage != ''>
                                        ...
                                        <div class="rel-blog position-relative mb-4">
                                            ...
                                            <div class="rel-content">
                                                <div class="rel-title transition-all" title="${xTitleRelated}">
                                                    <a href="<#if xURl?has_content>${xURl}<#else>javascript::void(0)</#if>"><b>${xTitleRelated}</b></a>
                                                </div>
...
<style type="text/css">
      ...
      .article-detail__content img.pull-right {
        height: 200px;
      }
      ...
      .article-detail-header .blog-category {
        display: flex;
        align-items: center;
      }
    
      .article-detail-header .blog-category p {
        margin-right: 10px;
      }
      ...
      .blog__shared-social img {
        width: 30px
      }
      .rel-content .article-publish {
        font-size: 13px;
      }
      .rel-content .article-meta {
        margin: 5px 0;
      }
      .rel-content .article-meta a {
        color: #808080;
        font-size: 15px;
      }
      .rel-content .article-meta a:hover {
      ...
      .rel-blog .blog-category {
        display: flex;
        align-items: center;
      }
    
      .rel-blog .blog-category p {
        margin-right: 20px;
        margin-bottom: 0;
        color: #747474;
        text-shadow: 0px 4px 30px rgba(0, 0, 0, 0.15);
      ...
      .rel-blog .blog-category p:not(:first-child)::before {
        position: absolute;
        content: '.';
        left: -12px;
        top: -4px;
      ...
      .article-detail__content img:not(.img-social) {
        width: 100%
      }
      ...
      .rel-blog a:hover .rel-title {
        color: var(--vng-orange);
      }
    
      @media (min-width: 576px) {
        .article-detail__content [class*='pull-'] {
          padding-top: 10px;
          padding-bottom: 5px;
        }
    
        .article-detail__content [class*='pull-']:not([class*='w-']) {
          width: 50%
        }
        ...
        .article-detail__content .pull-left {
          padding-right: 15px
        }
    
        .article-detail__content .pull-right {
          padding-left: 15px
        }
    
        .article-detail__content [class*='pull-'] img {
          width: 100%;
          height: auto;
        }
        ...
        .article-detail__content img.pull-left {
          height: 250px;
          padding-right: 10px;
        }
      ...
      @media (max-width: 575.98px) {
        ...
        .article-detail__content img:not(.cover-img):not(.img-social) {
          padding-bottom: 1rem;
        }
        ...
        .related-blog__title {
          border-left: 15px solid var(--dark-blue-2);
          padding: 5px 10px;
          background: #fff;
          display: inline-block;
        }
...
<#if css?has_content && css.getData() !=''>${css.getData()}</#if>
<script async="async" type="text/javascript">
  (function (d, s, id) {
    ...
    js.async = true;
    js.src =
      'https://connect.facebook.net/${themeDisplay.getLanguageId()}/sdk.js#xfbml=1&version=v3.2&appId=1844324365616250&autoLogAppblog=1';
    fjs.parentNode.insertBefore(js, fjs);
  }(document, 'script', 'facebook-jssdk'));
</script>
<script type="text/javascript" defer>
  $(document).ready(function () {
    let blockNext = document.getElementsByClassName('block-next');
    $(window).bind('scroll', function (e) {
      if ($(this).scrollTop() > 200) {
        blockNext[0].classList.add('fixed');
      } else {
        blockNext[0].classList.remove('fixed');
      }
    })
  })
</script>
